...
--Date        : Thu Apr 23 20:40:42 2020
--Host        : ANURAGCHOUDAFBF running 64-bit major release  (build 9200)
--Command     : generate_target design_BRAM_F_wrapper.bd
--Design      : design_BRAM_F_wrapper
...
entity design_BRAM_F_wrapper is
  port (
...
end design_BRAM_F_wrapper;

architecture STRUCTURE of design_BRAM_F_wrapper is
  component design_BRAM_F is
  port (
    BRAM_PORTA_0_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
    BRAM_PORTA_0_clk : in STD_LOGIC;
    BRAM_PORTA_0_din : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component design_BRAM_F;
begin
design_BRAM_F_i: component design_BRAM_F
     port map (
