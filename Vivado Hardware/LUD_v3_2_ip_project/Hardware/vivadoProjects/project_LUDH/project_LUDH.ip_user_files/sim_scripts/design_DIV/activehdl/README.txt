...
#
# Generated by export_simulation on Fri May 01 23:10:49 +0530 2020
#
################################################################################
...
'-reset_run' switch to the './design_DIV.sh' script.

./design_DIV.sh -reset_run
...
./design_DIV.sh -noclean_files

For more information on the script, please type './design_DIV.sh -help'.
