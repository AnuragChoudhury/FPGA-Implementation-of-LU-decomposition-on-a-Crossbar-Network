...
--Date        : Thu Apr 23 20:38:19 2020
--Host        : ANURAGCHOUDAFBF running 64-bit major release  (build 9200)
--Command     : generate_target design_BRAM_B_wrapper.bd
--Design      : design_BRAM_B_wrapper
...
entity design_BRAM_B_wrapper is
  port (
...
end design_BRAM_B_wrapper;

architecture STRUCTURE of design_BRAM_B_wrapper is
  component design_BRAM_B is
  port (
    BRAM_PORTA_0_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
    BRAM_PORTA_0_clk : in STD_LOGIC;
    BRAM_PORTA_0_din : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component design_BRAM_B;
begin
design_BRAM_B_i: component design_BRAM_B
     port map (
