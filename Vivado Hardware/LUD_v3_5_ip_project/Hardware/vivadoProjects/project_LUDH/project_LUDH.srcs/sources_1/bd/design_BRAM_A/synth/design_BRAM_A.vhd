...
--Date        : Thu May  7 15:33:53 2020
--Host        : ANURAGCHOUDAFBF running 64-bit major release  (build 9200)
--Command     : generate_target design_BRAM_A.bd
--Design      : design_BRAM_A
...
entity design_BRAM_A is
  ...
  attribute CORE_GENERATION_INFO of design_BRAM_A : entity is "design_BRAM_A,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_BRAM_A,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of design_BRAM_A : entity is "design_BRAM_A.hwdef";
end design_BRAM_A;

architecture STRUCTURE of design_BRAM_A is
  component design_BRAM_A_blk_mem_gen_0_0 is
  port (
    clka : in STD_LOGIC;
    ena : in STD_LOGIC;
  ...
  end component design_BRAM_A_blk_mem_gen_0_0;
...
blk_mem_gen_0: component design_BRAM_A_blk_mem_gen_0_0
     port map (
