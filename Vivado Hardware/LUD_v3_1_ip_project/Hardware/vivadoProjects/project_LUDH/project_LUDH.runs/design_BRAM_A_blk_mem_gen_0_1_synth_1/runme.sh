...
HD_PWD='/home/anuragchoudhury/mod_v_fix_v2_md_2018_ip/Hardware/vivadoProjects/project_LUDH/project_LUDH.runs/design_BRAM_A_blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_BRAM_A_blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_BRAM_A_blk_mem_gen_0_1.tcl
