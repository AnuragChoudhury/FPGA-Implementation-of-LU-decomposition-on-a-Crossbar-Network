...
#
# Generated by export_simulation on Fri May 01 20:44:33 +0530 2020
#
################################################################################
...
'-reset_run' switch to the './design_MAC.sh' script.

./design_MAC.sh -reset_run
...
./design_MAC.sh -noclean_files

For more information on the script, please type './design_MAC.sh -help'.
