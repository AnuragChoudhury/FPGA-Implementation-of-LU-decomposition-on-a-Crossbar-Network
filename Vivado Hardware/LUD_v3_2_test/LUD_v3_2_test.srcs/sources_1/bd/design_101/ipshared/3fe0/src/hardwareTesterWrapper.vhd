...
begin
    ...
    bram_ZYNQ_INST_dout_part_11 <= "000000000000000000000000000" & bram_ZYNQ_INST_dout(CTRL_WIDTH - 1 downto 352); --The no. of zeroes have to be adjusted if number of bits in control signals changes
