...
-- Date        : Thu Apr 23 18:09:15 2020
-- Host        : ANURAGCHOUDAFBF running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/anuragchoudhury/Desktop/local_documents/Vivado/LUD_v3_1_test/LUD_v3_1_test.srcs/sources_1/bd/design_101/ip/design_101_clk_wiz_0_0/design_101_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : design_101_clk_wiz_0_0
...
entity design_101_clk_wiz_0_0_design_101_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of design_101_clk_wiz_0_0_design_101_clk_wiz_0_0_clk_wiz : entity is "design_101_clk_wiz_0_0_clk_wiz";
end design_101_clk_wiz_0_0_design_101_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of design_101_clk_wiz_0_0_design_101_clk_wiz_0_0_clk_wiz is
  signal clk_in1_design_101_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_design_101_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_design_101_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_design_101_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_design_101_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_design_101_clk_wiz_0_0,
      O => clkfbout_buf_design_101_clk_wiz_0_0
    );
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_design_101_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_design_101_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out2_design_101_clk_wiz_0_0,
      O => clk_out2
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_101_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  ...
  attribute NotValidForBitStream of design_101_clk_wiz_0_0 : entity is true;
end design_101_clk_wiz_0_0;

architecture STRUCTURE of design_101_clk_wiz_0_0 is
begin
inst: entity work.design_101_clk_wiz_0_0_design_101_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2
