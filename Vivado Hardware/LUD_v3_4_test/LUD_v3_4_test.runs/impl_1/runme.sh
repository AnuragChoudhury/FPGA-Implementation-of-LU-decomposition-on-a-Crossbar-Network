...
HD_PWD='C:/Users/anuragchoudhury/Desktop/local_documents/Vivado/LUD_v3_4_test/LUD_v3_4_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_101_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_101_wrapper.tcl -notrace
