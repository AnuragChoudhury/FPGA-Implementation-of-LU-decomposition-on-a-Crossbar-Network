...
void test(struct HardwareConfig &simpleHardware, string testName,  string postfix)
{
        ...
        CCS A("../LUD/src/test/exported/" + testName + "/" + testName +"_amd_ALU", "A");
        CCS L(A.numRows, A.numCols, "L");
        CCS U(A.numRows, A.numCols, "U");
        ...
        CCS Uref("../LUD/src/test/exported/" + testName + "/" + testName + "_amd_U", "Uref");
        CCS Lref("../LUD/src/test/exported/" + testName + "/" + testName + +"_amd_L", "Lref");
